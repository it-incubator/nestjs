...
export class InitMigration1739702380498 implements MigrationInterface {
    name = 'InitMigration1739702380498'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "profile" ("id" SERIAL NOT NULL, "address" character varying NOT NULL, "music" character varying NOT NULL, "ownerId" integer, CONSTRAINT "REL_552aa6698bb78970f6569161ec" UNIQUE ("ownerId"), CONSTRAINT "PK_3dd8bfc97e4a77c70971591bdcb" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "album" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "photosCount" character varying NOT NULL, "description" TIMESTAMP NOT NULL, CONSTRAINT "PK_58e0b4b8a31bb897e6959fe3206" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "album_info" ("id" SERIAL NOT NULL, "count" integer NOT NULL, "updatedAt" TIMESTAMP NOT NULL, CONSTRAINT "PK_dade28169464a0fad816ceb77a8" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "photo" ("id" SERIAL NOT NULL, "url" character varying NOT NULL, "ownerId" integer NOT NULL, CONSTRAINT "PK_723fa50bf70dcfd06fb5a44d4ff" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TABLE "album_info"`);
